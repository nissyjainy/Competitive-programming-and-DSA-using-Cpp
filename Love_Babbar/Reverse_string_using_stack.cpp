...
class Solution
{
    ...
    {
        Node * node1 = new Node(d);//navi node list banave
        if(head == NULL) // clone wali linked list khali che to 
        {
            head = node1;
            tail = node1;
            return ;
    ...
    Node *copyList(Node *head)
    {
       Node * cloneHead = NULL;
       Node * cloneTail = NULL;
       Node * temp = head; //original mathi nakho ok
       while(temp!=NULL)
       {
       ...
       while(head!=NULL && cloneHead!=NULL)
       {
